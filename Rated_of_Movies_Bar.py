...
def rate_movies():
    """ Create Rated of Movies bar_graph of movies in year 2000-2016 and Load Dataset title and rate"""
    for year in range(2000, 2017):
        ...
        graph.render_to_file("Graph_Export/Rated_Movies/Bar/Rated_of_Movies_%i.svg" % year)
