"""
The-Movies : Revenue_of_Movies_Treemap
"""
import pandas as pd
import pygal
import time
...
def rate_movies():
    """ Create Rated of Movies treemap_graph of movies in year 2000-2016 and Load Dataset title and revenue"""
    for year in range(2000, 2017):
        ...
        graph = pygal.Treemap(x_title="Movie Name & Revenue")
